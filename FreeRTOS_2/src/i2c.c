...
uint8_t I2C_ReadByte(I2C_TypeDef* I2Cx, u8 slaveAddr, uint8_t address) {
...
uint8_t I2C_WriteByte(I2C_TypeDef* I2Cx, u8 slaveAddr, uint8_t address, uint8_t data) {
	...
	return I2C_ReadByte(I2Cx, slaveAddr, address);
}
